  ...
  async afterCreate(event) {
    ...
    try {
      await strapi.plugins["email"].services.email.send({
        ...
        text: "new contact request received from website!",
        html: `
          Dear Admin,<br /><br />
          You have received a new contact message via <strong>AZG</strong> website with the following information:<br /><br />
